...
json_string_validator_options_test() ->
    ...
    {invalid, {length, {must_be_greater_or_equal_to, 4}}} =
        json_validator:validate(<<"abc">>, Format),
    valid = json_validator:validate(<<"abcd">>, Format),

    valid = json_validator:validate(<<"abcdef">>, Format),
    {invalid, {length, {must_be_less_or_equal_to, 6}}} =
        json_validator:validate(<<"abcdefg">>, Format),
